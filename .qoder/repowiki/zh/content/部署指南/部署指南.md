...
本项目为基于 Spring Boot 的 CRUD 示例后端与 Vue 前端，后端使用 MySQL 存储，前后端通过反向代理统一对外提供服务。
...
- [README.deploy.md:222-226](file://README.deploy.md#L222-L226)
- [README.deploy.md:302-306](file://README.deploy.md#L302-L306)
- [application.yml:196-197](file://backend/src/main/resources/application.yml#L196-L197)
...
## 结论
本指南提供了从本地到生产的完整部署路径与运维建议。结合系统化的 CI/CD、监控与日志体系，以及安全加固与合规实践，可确保应用在不同环境下稳定运行与持续交付。
...
- [README.deploy.md:67-122](file://README.deploy.md#L67-L122)
- [README.deploy.md:153-252](file://README.deploy.md#L153-L252)
...
章节来源
- [README.deploy.md:413-422](file://README.deploy.md#L413-L422)
...
[本节为通用 CI/CD 建议，不直接对应具体源文件，故无“章节来源”]
...
章节来源
- [README.deploy.md:401-410](file://README.deploy.md#L401-L410)
